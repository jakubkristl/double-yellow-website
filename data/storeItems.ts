...
export const CATEGORIES: Category[] = [
  {
    ...
    items: [
      ...
      { name: "Tecnifibre Carboflex 120 X-Top V2", price: 163.61, image: "/store/products/rackets/Tecnifibre Carboflex 120 X-Top V2.webp" },
    ],
  },
  {
    title: "Shoes",
  ...
  },
  {
    ...
    items: [
      { name: "Unsquashable TOUR-TEC PRO Backpack", price: 50.62, image: "/store/products/bags/Unsquashable TOUR-TEC PRO Backpack.webp" },
