...
export const CATEGORIES: Category[] = [
  {
    ...
    items: [
      ...
      { name: "Unsquashable TOUR-TEC PRO 125", price: 89.00, image: "/store/products/rackets/Unsquashable TOUR-TEC PRO 125.webp" },
      { name: "Unsquashable JAMES WILLSTROP SIGNATURE", price: 75.00, image: "/store/products/rackets/Unsquashable JAMES WILLSTROP SIGNATURE.webp" },
      ...
      { name: "Unsquashable SAM GERRITS AUTOGRAPH", price: 95.00, image: "/store/products/rackets/Unsquashable SAM GERRITS AUTOGRAPH.webp" },
      { name: "Prince Vortex Pro 650", price: 89.00, image: "/store/products/rackets/Prince Vortex Pro 650.webp" },
      { name: "Dunlop Sonic Core Ultimate 132", price: 89.00, image: "/store/products/rackets/Dunlop Sonic Core Ultimate 132.webp" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Unsquashable TOUR-TEC PRO Deluxe Racket Bag", price: 91.52, image: "/store/products/bags/Unsquashable TOUR-TEC PRO Deluxe Racket Bag.webp" },
    ],
  },
  {
    title: "Strings & Grips",
