  ...
  return (
    <main className="container">
      <section className="page-hero">
        <h1 className="page-title">{(bg as any).bookingPage.title}</h1>
        <p className="muted">{(bg as any).bookingPage.subtitle} {" "}
          <a href={embedSrc} target="_blank" rel="noopener noreferrer">open the booking page in a new tab</a>.
        </p>
      </section>
